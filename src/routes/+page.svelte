...
<section class="h-screen">
  <div class="absolute h-screen inset-0 overflow-hidden">
    <img
      class="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 min-h-full min-w-full max-w-none"
      src={bg}
      alt="background"
    />
    <div
      class="absolute top-0 left-0 w-screen h-screen bg-[rgb(0,0,0,0.5)]"
    ></div>
  </div>
  <div class="relative pt-80 pl-4 min-[1400px]:pl-20 text-white">
    <h2
      class="font-bold leading-normal text-4xl min-[1400px]:text-[4rem] mb-16"
    >
      <p class="sm:inline-block align-top">Hi!👋</p>
      <p class="inline-block">I</p>
      <p
        class="texts inline-block align-top w-[300px] min-[1400px]:w-[500px] h-[6rem] overflow-y-hidden"
      >
...
<section class="h-28 flex justify-center items-center">
  <ul class="flex justify-center items-center text-xs">
    <li class="mx-1 py-1 px-2 rounded-full bg-gray-200 text-gray-800">
      WebDesign
    </li>
    <li class="mx-1 py-1 px-2 rounded-full bg-purple-100 text-purple-800">
      UI/UX
    </li>
    <li class="mx-1 py-1 px-2 rounded-full bg-blue-100 text-blue-800">
      Front/Back
    </li>
...
<section
  class="max-w-[500px] p-8 mx-auto flex flex-col justify-center items-center"
>
  <h2
    class="mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 relative"
  >
    <p class="relative z-[1]">History.</p>
    <div
      class="absolute h-[10px] inset-x-0 bottom-0 bg-red-300 opacity-60"
    ></div>
  </h2>
...
<section
  class="max-w-[900px] p-8 mt-8 mx-auto flex flex-col justify-center items-center"
>
  <h2
    class="mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 relative"
  >
    <p class="relative z-[1]">Portfolio.</p>
    <div
      class="absolute h-[10px] inset-x-0 bottom-0 bg-blue-300 opacity-60"
    ></div>
  </h2>
  <div class="flex flex-wrap gap-5 justify-center">
    <div
      class="works flex flex-col shadow w-[320px] h-[180px] relative rounded-xl"
    >
      <img src={test} alt="works" class="rounded-xl" />
      <div
        class="absolute inset-0 bg-[rgb(0,0,0,0.7)] opacity-0 text-white p-6 content-center transition rounded-xl"
      >
    ...
    >
      <div
        class="flex items-center justify-center w-full h-full bg-gray-300 rounded-xl"
      >
        <svg
      ...
      >
        ...
        <p class="text-sm">
          現在3つのWebアプリケーションが作成されています。詳しくは右上のボタンから。
        </p>
      </div>
    </div>
  </div>
...
>
  <h2
    class="mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 relative"
  >
    <p class="relative z-[1]">URLs.</p>
    <div
      class="absolute h-[10px] inset-x-0 bottom-0 bg-green-300 opacity-60"
    ></div>
  </h2>
  <div class="flex flex-col gap-5 justify-center font-semibold">
    <div class="bg-white hover:bg-gray-200 rounded-lg shadow-md">
      <a
        href="https://github.com/Glaesses3927"
        class="px-6 py-2 flex flex-row items-center"
      >
...
<section
  class="max-w-[600px] p-8 mt-8 mx-auto flex flex-col justify-center items-center"
>
  <h2
    class="mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 relative"
  >
    <p class="relative z-[1]">Contact.</p>
    <div
      class="absolute h-[10px] inset-x-0 bottom-0 bg-gray-300 opacity-60"
    ></div>
  </h2>
  <form
    method="POST"
    ...
    class="w-full"
  >
    <label for="name-icon" class="block mb-2 text-sm font-medium text-gray-900"
      >お名前</label
    >
    <div class="relative">
      <div
    ...
    <label
      ...
      class="block mb-2 mt-6 text-sm font-medium text-gray-900"
      >メールアドレス</label
    >
    <div class="relative">
      <div
    ...
    <input
      ...
      bind:value={recaptchaResponse}
    />
    {#if status == "waiting"}
      <button
        type="submit"
        class="mt-4 mx-auto py-2 px-16 text-sm font-bold text-center text-white rounded-lg bg-blue-600 hover:bg-blue-700 flex"
      >
        送信
      </button>
    {:else if status == "sending"}
      <button
        type="submit"
        class="mt-4 mx-auto py-2 px-16 text-sm font-bold text-center text-white rounded-lg bg-gray-400 flex"
        disabled
      >
        送信中...
      </button>
    ...
    <p class="text-xs text-gray-400 mt-2 text-center">
      ...
      <a href="https://policies.google.com/privacy" class="text-blue-400"
        >Privacy Policy</a
      >
      and
      <a href="https://policies.google.com/terms" class="text-blue-400"
        >Terms of Service</a
      > apply.
    </p>
  </form>
